...
class MemoLinearViewHolder (var binding : ItemMemoLinearLayoutBinding ,var memoDeleteClickInterface : MemoDeleteClickInterface) : RecyclerView.ViewHolder(binding.root)  {
